...
var target = require('./endpoints/target')
var route = require('./endpoints/route')

router.set('/favicon.ico', empty)
router.set('/api/targets', target._index)
router.set('/api/target/:id', target._id)
router.set('/route', route._index)
